                            ...
                            <div className='flex gap-5'>
                                ...
                                <div className='w-[62%]'>
                                    ...
                                    <div className='mb-3 p-1'>
                                        ...
                                        <input type='name' name='subcategoryName' id='subcategoryName' className='text-[20px] border-2 py-2 px-2 block shadow-md
                                    ...
                                    <div className='mb-3 p-1'>
                                        ...
                                        <input type='number' name='subcategoryOrder' id='subcategoryOrder' className='text-[20px] border-2 py-2 px-2 block shadow-md
