...
const { sub_subcategoryInsert, parentCategory, subCategoryData, sub_subcategoryView } = require("../../controllers/admin/sub-subcategoryController");
...
sub_subcategoryRoutes.get("/subcategory/:parentId", subCategoryData)
